            ...
            <div class="admin-stats-grid" id="stats-grid">
                ...
                <div class="admin-stat-card">
                    <span class="admin-stat-value"
                        id="stat-zombies-estado"><?= $zombiesVisibles ? '🔴 ON' : '🟢 OFF' ?></span>
        ...
        <section class="admin-section" aria-label="Control de zombies">
            ...
            <div class="zombie-control-card <?= $zombiesVisibles ? 'zombies-on' : 'zombies-off' ?>" id="zombie-card">
                <div class="zombie-control-info">
                    ...
                    <div class="zombie-status-text <?= $zombiesVisibles ? 'activos' : 'inactivos' ?>"
                        id="zombie-status-text">
                ...
                <div class="toggle-container">
                    <span class="toggle-label-text <?= $zombiesVisibles ? 'toggle-on-label' : 'toggle-off-label' ?>"
                        id="toggle-label">
